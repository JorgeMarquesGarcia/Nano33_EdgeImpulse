...
const char* ei_classifier_inferencing_categories[] = { "NOISEup", "Pitch NEG", "Pitch POS", "Roll NEG", "Roll POS", "Yaw NEG", "Yaw POS" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_9_axes[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
const uint32_t ei_dsp_config_9_axes_size = 9;
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_10 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_10_inputs[1] = { 9 };
...
const ei_impulse_t impulse_640615_0 = {
    .project_id = 640615,
    .project_owner = "Jorge Marqués García",
    .project_name = "JMarques-project-1",
    .impulse_id = 3,
    .impulse_name = "Impulse #3",
    .deploy_version = 9,

    .nn_input_frame_size = 117,
    .raw_sample_count = 80,
    .raw_samples_per_frame = 9,
    .dsp_input_frame_size = 80 * 9,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 50,
...
ei_impulse_handle_t impulse_handle_640615_0 = ei_impulse_handle_t( &impulse_640615_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_640615_0;
